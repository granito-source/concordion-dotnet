...
public class SpecificationConfig {
    ...
    /// </summary>
    /// <value>The base input directory, <c>null</c>
    /// indicates that specifications are embedded in DLL file.</value>
    ...
    /// <value>Qualified type names together with assembly names of
    /// Concordion extensions.</value>
    public IDictionary<string, string> ConcordionExtensions { get; } =
    ...
    public List<string> SpecificationFileExtensions { get; } = ["html"];
