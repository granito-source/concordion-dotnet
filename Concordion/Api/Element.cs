...
public class Element
{
    ...
    {
        var descendantElements = new List<Element>();

        foreach (var element in m_element.Descendants())
        {
    ...
    {
        foreach (var descendant in m_element.Descendants())
        {
    ...
    {
        var attribute = m_element.Attribute(XName.Get(attributeName));
    ...
    {
        var attribute = m_element.Attribute(XName.Get(attributeName, namespaceName));
